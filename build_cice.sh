...
echo "=   SYNTAX:                                                      ="
echo "=     build_cice.sh [runcice=NO|YES]                             ="
echo "=                                                                ="
echo "=================================================================="
